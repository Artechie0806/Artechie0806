...
- **[Brain Stroke Detection](https://github.com/Artechie0806/Brain-Stroke-Classification)** — a Vision Transformer (ViT-B16) that flags stroke indicators in scans at 90%+ accuracy, and held up better than the CNN baselines I compared it against.
